namespace OneRepMax
{
    public interface IOneRepMaxCalculator
    {
        ...
        /// <param name="formula">ICalculatorStrategy object that implements the desired formula.</param>
        /// <returns>
        ...
        /// </returns>
        double Calculate(double weight, int reps, ICalculatorStrategy formula);
    }
}